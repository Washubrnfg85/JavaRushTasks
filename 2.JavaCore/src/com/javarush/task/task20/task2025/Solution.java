...
public class Solution {
    ...
    /*public static long[] getNumbers(long N) {
        ...
        long[] armstrongNumbers = new long[] {
        ...
        for (int i = 0; i < armstrongNumbers.length; i++) {
            if (N < armstrongNumbers[i] && i < armstrongNumbers.length) {
                result = Arrays.copyOf(armstrongNumbers, i);
                break;
            } else {
                result = armstrongNumbers;
            }
        }
...
*/
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(getNumbers(200)));
